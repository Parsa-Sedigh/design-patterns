...
class SomeComponent:
    ...
    def __init__(self, some_int: int, some_list_of_objects: List[object], some_circular_ref: Any):
    ...
    def __copy__(self):
        ...
        # nested objects:
        new_copy = self.__class__(self.some_int, some_list_of_objects, some_circular_ref)
    ...
    def __deepcopy__(self, memo=None):
        ...
        new_copy.__dict__ = copy.deepcopy(self.__dict__, memo)
...
if __name__ == "__main__":
    ...
    # Let's change the list in shallow_copied_component and see if it changes in component(SPOILER: Yes it does):
    shallow_copied_component.some_list_of_objects.append("another object")

    if shallow_copied_component.some_list_of_objects[-1] == "another object":
        print(
    ...
    # Let's change the set in the list of objects(SPOILER: yes the set in component changes as well).
...
# ^^ This shows that deep-copied objects contain same reference, they are not cloned repeatedly.
